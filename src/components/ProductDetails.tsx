        ...
        <tr className="border-b ">
            ...
            <td className="p-3 text-lg text-gray-800">
                <fetcher.Form method="POST" className="">
                    ...
                    uppercase font-bold w-full border border-black-100 hover:cursor-pointer
                    `}
                    >
                ...
                <div className="flex gap-2 items-center">
                    <button
                        ...
                        className='bg-indigo-600 text-white rounded-lg w-full p-2 uppercase
                            font-bold text-xs text-center hover:bg-indigo-700'
                        >    
                        Editar
                    </button>
                    ...
                    >
                        <input type="submit" value="Eliminar "
                            ...
                            font-bold text-xs text-center hover:bg-red-700' />
                    </Form>
                </div>
            </td>
        </tr>
